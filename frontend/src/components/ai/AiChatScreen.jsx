...
//   const fetchMesage = useCallback(async () => {
//     try {
...
//               role: "assistant",
//               content:
//                 "Xin chào! Tôi là Ánh - trợ lý AI của bạn. Tôi có thể giúp gì cho bạn hôm nay? 😊",
//               timestamp: new Date(),
//             },
//           ];
//         });
...
//       updateSuggestions(res.data.reply);
//     } catch (err) {
//       const errorMsg = {
//         role: "assistant",
//         content: "Ánh đang bận chút xíu, bạn đợi nhé ❤️",
//         timestamp: new Date(),
//       };
...
//               <h1 className="ai-chat-title">Ánh AI Assistant</h1>
...
//                   )}
//                   {m.role === "assistant" && (
//                     <span className="ai-message-sender">Ánh AI</span>
//                   )}
//                 </div>
//               </div>
...
//             <small>Mẹo: Nhấn Enter để gửi nhanh</small>
//           </div>
...
export default function AiChatScreen() {
  ...
  const send = async (customMessage = null) => {
    ...
    try {
      ...
      const webhookUrl = "https://dinhcongminh.app.n8n.cloud/webhook/ai-anh";
